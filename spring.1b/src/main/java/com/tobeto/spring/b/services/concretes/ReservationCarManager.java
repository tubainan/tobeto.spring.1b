...
import com.tobeto.spring.b.repositories.ReservationCarRepository;
...
@Service
@AllArgsConstructor
public class ReservationCarManager implements ReservationCarService {
    private final ReservationCarRepository ReservationCarRepository;
